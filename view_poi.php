...
<!DOCTYPE html>
<html>
<title><?php include('pages/title'); ?></title>
<meta charset="UTF-8">
...
<!-- Page Content -->
  ...
  <div class="w3-padding-64 w3-content w3-text-grey" id="contact">
   <center><h2 class="w3-text-light-grey" style="margin-top:-4%;text-align:centre">POI Info</h2>
    </center>
  ...
  <a target="_blank" href="image/<?php echo $res['photo'];?>">
    ...
    <br />
    <button type="button" class="registerbtn fill-in" style="background-color:#f44336" onClick="location.href='index'"  >Home</button>
